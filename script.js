...
function area () {
  ...
  area = (A+B)/2*H // Performs the area calculation.
  document.getElementById('number').innerHTML = 'Your area is ' + area + ' units squared!' // Prints the area out to the user on the page.
  if (isNaN(area)) {
